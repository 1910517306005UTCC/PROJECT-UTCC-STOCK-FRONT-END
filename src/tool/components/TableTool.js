...
const columns = [
    { id: 'name', label: 'Image', minWidth: 100 },
                                    ...
                                    <TableRow hover role="checkbox" tabIndex={-1} key={index}>
                                        ...
                                        <TableCell align="left">
                                            <div className="table-tool-btn-action">
                                                <Button variant="contained" color="primary" onClick={() => handleOpenModal(tool.nameTool, index, "Request")}>
                                                    request
                                                </Button>
                                                <Button variant="contained" onClick={() => handleOpenModal(tool.nameTool, index, "Add")} style={{ background: "#28a745", color: "#fff" }}>
                                                    add
                                                </Button>
                                            </div>
                                        </TableCell>
